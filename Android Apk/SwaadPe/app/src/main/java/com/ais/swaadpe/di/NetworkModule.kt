...
import com.ais.swaadpe.utils.NetworkConnectivityObserver
...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideSwaadPeApi(retrofit: Retrofit): SwaadPeApi {
        return retrofit.create(SwaadPeApi::class.java)
    }
